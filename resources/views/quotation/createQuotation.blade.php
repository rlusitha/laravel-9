            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Quotation Creation Form</h6>
                    </div>
                    <div class="card-body">
                        <!-- Image preview start -->
                        <div class="bikini-product-container">
                            <div class="bikini-grid1">
                                <div class="bikini-img-container">
                                    <img id="bikini-display1" src="{{ $contents }}">
                                    <img id="bikini-display2" src="https://c1.staticflickr.com/1/969/41214562765_aa18316183_b.jpg">
                                    <img id="bikini-display3" src="https://c1.staticflickr.com/1/980/28242872048_1e6d11b6e9_b.jpg">
                                    <img id="bikini-display4" src="https://c1.staticflickr.com/1/951/28242872018_542c529d4d_b.jpg">
                                </div>

                                <div class="bikini-thumbnail">
                                    <img id="clickMe1" class="bikini-thumbnails" src="https://c1.staticflickr.com/1/823/27245062607_5f7ee01e31_b.jpg">
                                    <img id="clickMe2" class="bikini-thumbnails" src="https://c1.staticflickr.com/1/969/41214562765_aa18316183_b.jpg">
                                    <img id="clickMe3" class="bikini-thumbnails" src="https://c1.staticflickr.com/1/980/28242872048_1e6d11b6e9_b.jpg">
                                    <img id="clickMe4" class="bikini-thumbnails" src="https://c1.staticflickr.com/1/951/28242872018_542c529d4d_b.jpg">
                                </div>
                            </div>

                            <div class="bikini-grid2">
                                <div class="bikini-buy-details">
                                    <div class="product-details" style="font-family:'run_wildregular'; font-size: 28px;">villa tropical top
                                    </div>
                                    <p class="price" style="font-size: 15px;">$68.00</p>
                                    <hr>
                                    <div class="product-details" style=" font-size: 15px;">fabric</div>
                                    <div class="colors">
                                        <div class="color-item1">
                                            <img class="img1" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name1">
                                                <div class="fn1" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item2">
                                            <img class="img2" src="https://c1.staticflickr.com/1/974/27370825057_cdaf041d60_o.png" height="50px;">
                                        ...
                                        <div class="color-item3">
                                            <img class="img3" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name3">
                                                <div class="fn3" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item4">
                                            <img class="img4" src="https://c1.staticflickr.com/1/974/27370825057_cdaf041d60_o.png" height="50px;">
                                        ...
                                        <div class="color-item5">
                                            <img class="img5" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name5">
                                                <div class="fn5" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item6">
                                            <img class="img6" src="https://c1.staticflickr.com/1/974/27370825057_cdaf041d60_o.png" height="50px;">
                                        ...
                                        <div class="color-item7">
                                            <img class="img7" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name7">
                                                <div class="fn7" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item8">
                                            <img class="img8" src="https://c1.staticflickr.com/1/974/27370825057_cdaf041d60_o.png" height="50px;">
                                        ...
                                        <div class="color-item9">
                                            <img class="img9" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name9">
                                                <div class="fn9" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item10">
                                            <img class="img10" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name10">
                                                <div class="fn10" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item11">
                                            <img class="img11" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
                                            <div class="fabric-name11">
                                                <div class="fn11" style="font-family:'run_wildregular';">palmalicious</div>
                                            </div>
                                        </div>
                                        <div class="color-item12">
                                            <img class="img12" src="https://c1.staticflickr.com/1/944/42169965352_a0bc1fef3a_o.jpg" height="50px;">
