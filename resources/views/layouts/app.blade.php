...
<head>
    ...
    <link href="{{ asset('css/stylesForImagePreview.css') }}" rel="stylesheet">
    <link href="{{ asset('css/drugTable.css') }}" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">XITEB</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('prescription.create') }}">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('view_prescriptions') }}">
                    <i class="fa fa-sticky-note" aria-hidden="true"></i>
