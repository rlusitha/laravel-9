...
<body class="antialiased">
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div>
            <!-- <h1 style="color: white; font-size:75px;">Prescription Managment System</h1> -->
            <h1 class="text-lime-400 text-lg" style="font-size: 75px;">Prescription Managment System</h1>
        </div>
    </div>
</body>
